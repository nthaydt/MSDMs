...
write.csv(pred.df.blit, file = "/home/nhaydt/NRT_Project/mean_bact_preds_Ic_250thous_US.csv")

EpredY <- Reduce("+",predY_flit )/length(predY_flit )
pred.df.flit <- as.data.frame(EpredY)
write.csv(pred.df.flit, file = "/home/nhaydt/NRT_Project/mean_fung_preds_Ic_250thous_US.csv")